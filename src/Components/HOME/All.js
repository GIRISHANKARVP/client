...
{    
    ...
    const fetchdataAgri=async ()=>
    {
        ...
        const products=await axios.get("https://native-innovites.herokuapp.com/agri");
    ...
    {
        const products=await axios.get("https://native-innovites.herokuapp.com/software");
        //console.log("data is",products);  //all will come ,not possible to find an item
        setData(products.data);  
        setDis(true)
    }
    ...
    const fetchdataAutomobile=async ()=>
    {
        ...
        const products=await axios.get("https://native-innovites.herokuapp.com/auto");
        //console.log("data is",products);  //all will come ,not possible to find an item
        setData(products.data);  
        setDis(true)
    }
    ...
    const fetchdataElectrical=async ()=>
    {
        ...
        const products=await axios.get("https://native-innovites.herokuapp.com/electrical");
        //console.log("data is",products);  //all will come ,not possible to find an item
        setData(products.data);  
        setDis(true)
    }
    ...
    const fetchdataRecycling=async ()=>
    {
        ...
        const products=await axios.get("https://native-innovites.herokuapp.com/recycling");
        //console.log("data is",products);  //all will come ,not possible to find an item
        setData(products.data);  
        setDis(true)
    }
    ...
    {
        const products=await axios.get("https://native-innovites.herokuapp.com");
        //console.log("data is",products);  //all will come ,not possible to find an item
        setData(products.data);  
        setDis(true)
    }
